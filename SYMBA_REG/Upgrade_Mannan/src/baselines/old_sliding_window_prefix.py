...
class SymbolicDecoder(nn.Module):
    ...
    def forward(self, embedding, target_ids):
        ...
        # FIX 1: Shift the inputs to length T-1 so it can't see the future
        ...
        # FIX 2: Change pos_embedding to :T instead of :T+1
...
# ==========================================
# 6. Plot Loss and Accuracy Side-by-Side
# ==========================================

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 5))

# --- Plot 1: Loss (Left Subplot) ---
color1 = 'tab:red'
...
# Add a clean global title for the whole image
fig.suptitle("Prefix Notation", fontsize=14, fontweight='bold')
